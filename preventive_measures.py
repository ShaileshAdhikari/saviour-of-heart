...
class Ui_Dialog_preventive(object):
    def __init__(self, Age,SBP,HDL,TCL,Gender,Smoke,TOH,Diabetes, Risk):
        ...
        #self.final_risk = int(self.final_risk)
          
    def setupUi(self, Dialog):
        
        
        if self.final_risk < 5:
            self.preventive = "Safe\nYou don’t have much risk of heart disease in future 10 years if you can maintain \n this life style if anyone in your family is suffering from ASCVD  you must \nsee some medical officials"
            
        elif self.final_risk < 10:
            self.preventive ="!!! Alert !!!\n You have not so much of risk of having ASCVD in future 10 \nyears, but it is better to visit doctors if someone in your family \n is suffering from ASCVD you must visit doctors as soon as possible"

        elif self.final_risk < 20:
            self.preventive = "!!! Caution !!!\nYou must changing and medie your lifestyle, exerciscating might help,\n You must visit doctor as soon as possible, things might get \n more serious if someone in your family is suffered from ASCVD"

        elif self.final_risk < 30:
            self.preventive ="!!! Warning !!!\nYou must change your lifestyle, exercising and medicating might help, You must visit doctors immediately,\n Things might get more serious if someone in your family is suffered from ASCVD so you must start some medication immediately"
        ...
        if self.Smoke == "1":
            self.preventive1 ="-> Stop smoking"
        
        
        if self.Diabetes == "1":
            self.preventive1 ="-> Try to eat/drink food having minimal amount of sugar, Check up your sugar level periodically"
        
        else:
            self.preventive1 ="-> Do not eat/drink food having a lot of sugar content" 
        
        
        if self.HDL < 40:
            self.preventive2 ="-> Increase your HDL cholesterol level maintaining between 60-100mg/dl by Aerobic exercise for 30 -60 minutes per day,\n Do not smoke, Do medication and keeping healthy weight and immediately visit your doctor"
                           
        elif self.HDL < 60:
            self.preventive2 ="-> Increase your Hdl cholesterol level maintaining between 60-100 mg/dl by Aerobic exercise for 30-60 minutes per day,\n Do not smoke, Do medication and keeping healthy weight. Visit doctor frequently"
                           
        elif self.HDL < 100:
            self.preventive2 ="->Try to maintain your HDL cholesterol level between 60- 100mg/dl",
                           
        elif self.HDL < 129:
            self.preventive2 ="-> Reduce you HDL cholesterol level below 100mg/dl by consuming olive oil,\n Eat fatty fish, Follow low-carb or ketogenic diet"
                           
        else:
            self.preventive2 ="-> Consume olive oil, eat fatty fish, follow low-arb and ketogenic diet,\n visit doctor immediately. Your HDL level is at maximum risk."
                           
        
        if self.TCL < 120:
            self.preventive3 ="-> Maintain your total cholesterol around 200mg/dl by reducing saturated meat avoiding red meat,\n avoid eating store-bought cookies since it contains vegetable oil,\n eating Omega-3 rich food like salmon, walnuts, increasing soluble fiber eating oatmeal, kidney beans, sprouts, apples and\n immediately visit the doctor"
                           
        elif self.TCL < 180:
            self.preventive3 ="-> Maintain your total cholesterol level around 200mg/dl by reducing saturated meat avoiding red meat,\n avoid eating store-bought cookies since it contains vegetable oil,\n eating Omega-3 rich food like salmon, walnuts, increasing soluble fiber eating oatmeal, kidney beans, sprouts, apples and\n frequently visit doctor"
                           
        elif self.TCL < 200:
            self.preventive2 ="-> Try to maintain your Total cholesterol level below 200mg/dl by having healthy life style",  
        
        elif self.TCL < 240:
            self.preventive3 ="->Try to maintain your total cholesterol level below 200mg/dl by reducing saturated meat avoiding red meat,\n avoid eating store-bought cookies since it contains vegetable oil,\n eating Omega-3 rich food like salmon, walnuts, increasing soluble fiber eating oatmeal, kidney beans, sprouts, apples"
        ...
        if self.SBP < 100:
            self.preventive4 ="-> Try to maintain the Systolic blood pressure around 120mmHg by eating healthy diet,\n diet rich in fruits, vegetables, whole grains and low-fat dairy products and\n visit doctor frquently"
                           
        elif self.SBP < 120:
            self.preventive4 ="-> Try to maintain the Systolic blood pressure around 120mmHg by eating healthy diet,\n diet rich in fruits, vegetables, whole grains and low-fat dairy products"
                           
        elif self.SBP < 140 and self.TOH == 0:
            self.preventive4 ="-> Try to cut down on salt, exercise a lot, treat for possible Hypertension"
                           
        elif self.SBP < 140 and self.TOH == 1:
            self.preventive4 ="-> Try to cut down on salt, exercise a lot, treat for Hypertension"
        else:
            self.preventive4 ="-> Cut down on salt, exercise a lot, immediately visit doctor before it gets too serious"
        ...
        #TODO: for preventive measure formatting
        font = QtGui.QFont()
...
"https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2465638/"))
        ...
        self.label_24.setText(_translate("Dialog", "Preventive Measures"))
        
        #for displaying preventive measures
        self.total_prevent= self.preventive+"\n"+self.preventive1+"\n"+self.preventive2+"\n"+self.preventive3+"\n"+self.preventive4
        print(self.total_prevent)
        self.label_25.setText(_translate("Dialog", self.total_prevent))
        
        # self.pushButton.setText(_translate("Dialog", "More about Risk Score"))
#import heart_rc
